...
namespace EstateSaleUI.ViewComponents.EstateAgent
{
    public class _EstateAgentDashboardStatisticComponentPartial: ViewComponent
    {
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            var responseMessage1 = await client1.GetAsync("https://localhost:44362/api/EstateAgentDashboardStatistic/AllProductCount");
            ...
            var responseMessage2 = await client2.GetAsync("https://localhost:44362/api/EstateAgentDashboardStatistic/ProductCountByEmployeeId?id" +id);
            ...
            var responseMessage3 = await client3.GetAsync("https://localhost:44362/api/EstateAgentDashboardStatistic/ProductCountByStatusTrue?id" +id);
            ...
            var responseMessage4 = await client4.GetAsync("https://localhost:44362/api/EstateAgentDashboardStatistic/ProductCountByStatusFalse?id" +id);
