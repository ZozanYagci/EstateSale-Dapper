using EstateSaleUI.Dtos.MessageDtos;
using EstateSaleUI.Services;
using Microsoft.AspNetCore.Mvc;
using Newtonsoft.Json;

namespace EstateSaleUI.Areas.EstateAgent.ViewComponents.EstateAgentNavbarViewComponents
{
    public class _NavbarLast3MessageComponentPartial:ViewComponent
    {
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            var responseMessage = await client.GetAsync("https://localhost:44362/api/Messages?id=" + id);
